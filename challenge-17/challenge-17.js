(function(){
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/g, 'Fernando Feliu'));
  ...
  */
  ...
  console.log('O Centauro de Luvas'.replace(/(\w)/g, function(capturaTotal, letra) {
  ...
  */
  ...
  var regexDate = /[0-9][0-9]\/03|07|12\/[0-9][0-9]/g
