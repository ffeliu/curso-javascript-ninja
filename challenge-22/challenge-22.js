(function (win, doc) {
  ...
  */
  function sum() {
    ...
    return Array.prototype.reduce.call(arguments, function(valorAcumulado, actualItem) {
      return Number(valorAcumulado) + Number(actualItem);
    });
  }
  ...
  */
  ...
  function justNumbers(stringQualquer) {
    return stringQualquer.replace(/\D+/g, ',').split(',');
  }
