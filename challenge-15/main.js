(function() {
    ...
    */
    ...
    var fernando = new Person('Fernando', 'Feliu', 38);
    var ana = new Person('Ana', 'Storni', 47);
    var buddy = new Person('Buddy', 'Feliu', 2);
    ...
    */
    ...
    console.log(buddy.getFullName() + ' tem ' + buddy.getAge() + ' anos.');
    ...
    */
    ...
    console.log(buddy.getFullName() + ' agora tem ' + buddy.getAge() + ' anos.');
