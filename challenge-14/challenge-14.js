(function() {
  ...
  */
  console.log( '\nOperation:' );
  var operation = justMod2Or3.reduce( function(reduceValue, item) {

    return (reduceValue + 1) * item;
  ...
  */
  console.log( '\nOperation 2:' );
  var operation2 = justMod2Or3.reduceRight( function(reduceValue, item) {
  ...
  */
  ...
  console.log(numberObjects.lastIndexOf(obj, 2) > -1 ? 'Existe um objeto { number: 2 } em numberObjects!' : 'Não existe um objeto { number: 2 } em numberObjects :(');
  ...
  */
  ...
  console.log( Array.isArray(justMod2Or3) ? justMod2Or3.toString() : 'Nao eh um array');
})();
