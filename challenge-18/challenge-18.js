(function() {
  ...
  */
  ...
  var regexCleanCPF = /\D/g; //\D qq coisa que não seja caracter
  ...
  console.log(cpf1, cleanCPF(cpf1));
  console.log(cpf2, cleanCPF(cpf2));
  console.log(cpf3, cleanCPF(cpf3));
  console.log(cpf4, cleanCPF(cpf4));
  ...
  */
  ...
  //   return cpf.replace(regexCPF, function(captura, parte1, parte2, parte3, parte4) {
  ...
  console.log(cpf1, formatCPF(cleanCPF(cpf1)));
  console.log(cpf2, formatCPF(cleanCPF(cpf2)));
  console.log(cpf3, formatCPF(cleanCPF(cpf3)));
  console.log(cpf4, formatCPF(cleanCPF(cpf4)));
  ...
  */
  ...
  var textoJunhoJulho = 'Os meses de janeiro, junho e julho começam com a letra j.';
  var regexJunhoJulho = /ju[nl]ho/g;

  console.log(textoJunhoJulho.match(regexJunhoJulho));
  ...
  */
  ...
  console.log(textoHtml.match(regexHtml));
  ...
  */
  ...
  var textoHtml2 = "<div><ul><li></li><li></li><li><span></span></li></ul></div>";

  console.log(textoHtml2.match(regexHtml2));
